...
## [0.1.5](https://github.com/okkez/clh-client/compare/v0.1.4...v0.1.5) - 2026-09-14

### Other

- *(deps)* update rust crate clap to v4.6.7 ([#83](https://github.com/okkez/clh-client/pull/83))
- *(deps)* update rust crate toml to v1.1.6 ([#82](https://github.com/okkez/clh-client/pull/82))
- *(deps)* update github actions
- *(deps)* update rust crate toml to v1.1.5 ([#78](https://github.com/okkez/clh-client/pull/78))
- *(deps)* update taiki-e/install-action action to v2.85.11
- *(deps)* update rust crate clap to v4.6.6 ([#76](https://github.com/okkez/clh-client/pull/76))
- *(deps)* update rust crate clap to v4.6.5 ([#75](https://github.com/okkez/clh-client/pull/75))
- *(deps)* update github actions
- *(deps)* update rust crate toml to v1.1.4 ([#73](https://github.com/okkez/clh-client/pull/73))
